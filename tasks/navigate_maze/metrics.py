...
to indicate which side the wall is on:
  Wall 1: (2.0, +0.1) — wall blocks y>0, edge at y=0
  Wall 2: (4.0, -0.1) — wall blocks y<0, edge at y=0
...
def get_metrics():
    return [
        NavigateMazeMetric(
            ...
            obstacle_positions=[
                (2.0,  0.1),  # wall 1 inner edge (blocks y>0)
                (4.0, -0.1),  # wall 2 inner edge (blocks y<0)
            ],
